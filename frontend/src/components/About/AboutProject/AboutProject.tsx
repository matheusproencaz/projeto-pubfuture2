        ...
        <div className="container" id="AboutProject">
            <div className="row">
                ...
                <div className="col-12" id="p-desafio">
                    ...
                    <p>Minha primeira aplicação foi desenvolvida usando apenas Java, MySQL e JavaFX, consistia em um CRUD em que o usuário poderia criar uma conta ou entrar no programa em um simples sistema de login, que apenas verificava se a conta constava no banco de dados.
                    No mesmo programa também era possível acessar as telas de cadastro de uma conta como também de receitas e despesas, também foram feitos filtros e um simples sistema de transação de saldo entre contas. O primeiro slider apresenta como eram as telas.</p>
